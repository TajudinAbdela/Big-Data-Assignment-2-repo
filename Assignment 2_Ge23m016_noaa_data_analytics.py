...
import pandas as pd
##########################################
FILE_PATH = '/Users/KIIT/tajudin/big_data_lab/'
...
def process_and_filter_csv(files):    
    ...
    output_path = '/Users/KIIT/tajudin/big_data_lab/'
...
process_csv_task = PythonOperator(
    ...
    op_args=[f'{FILE_PATH}/{filename}' for filename in os.listdir('/Users/KIIT/tajudin/big_data_lab/') if filename.endswith('.csv')],
    dag=dag,
)
...
compute_averages_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[os.path.join('/Users/KIIT/tajudin/big_data_lab/', 'output.txt'),
             os.path.join('/Users/KIIT/tajudin/big_data_lab/', 'monthly_averages.txt')],
    dag=dag,
)
###################################
...
create_visualizations_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[os.path.join('/Users/KIIT/tajudin/big_data_lab/', 'monthly_averages.txt'),
             os.path.join('/Users/KIIT/tajudin/big_data_lab/', 'visualizations')],
    dag=dag,
)
