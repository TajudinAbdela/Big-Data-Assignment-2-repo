...
fetch_page_task = BashOperator(
    task_id='fetch_page',
    bash_command=f'wget -O /Users/KIIT/tajudin/page_fetch.html {BASE_URL}{YEAR}/',
    dag=dag,
)
...
def extract_csv_links():
    with open('/Users/KIIT/tajudin/page_fetch.html', 'r', encoding='utf-8') as file:
...
place_archive_task = BashOperator(
    ...
    bash_command=f'mv /Users/KIIT/tajudin/noaa_archive.zip {OUTPUT_PATH}',
    dag=dag,
)
